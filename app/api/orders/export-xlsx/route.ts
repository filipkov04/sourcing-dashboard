...
export async function GET(request: NextRequest) {
  try {
    ...
    ws1.columns = [
      ...
      { header: "Expected Start Date", key: "expectedStartDate", width: 16 },
      { header: "Placed Date", key: "placedDate", width: 12 },
    ...
    for (const order of orders) {
      ws1.addRow({
        ...
        expectedStartDate: formatDate(order.expectedStartDate),
