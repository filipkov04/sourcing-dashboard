...
import { ArrowLeft, Factory as FactoryIcon, Loader2, Send } from "lucide-react";
...
export default function FactoryEditRequestPage() {
    ...
    return (
      <div className="max-w-lg mx-auto mt-20 text-center space-y-4">
        ...
        <p className="text-gray-500 dark:text-zinc-400">
          Your factory edit request has been submitted for admin review. You&apos;ll be notified once it&apos;s been processed.
        </p>
        <div className="flex justify-center gap-3 pt-4">
          <Link href={`/factories/${params.id}`}>
            <Button variant="outline">Back to Factory</Button>
          </Link>
          <Link href="/factories">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Request Factory Edit</h1>
          <p className="text-sm text-gray-500 dark:text-zinc-400">Submit changes to {name} for admin approval</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Reason for Changes */}
            <Card className="bg-white dark:bg-zinc-800 border-amber-200 dark:border-amber-900/50">
              <CardHeader>
                <CardTitle className="text-gray-900 dark:text-white">Reason for Changes</CardTitle>
                <CardDescription className="text-gray-500 dark:text-zinc-400">
                  Explain why this factory needs to be edited
                </CardDescription>
              </CardHeader>
              <CardContent>
                <textarea
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-white dark:bg-zinc-800 border-gray-200 dark:border-zinc-700">
              <CardHeader>
                <CardTitle className="text-gray-900 dark:text-white">Submit Request</CardTitle>
                <CardDescription className="text-gray-500 dark:text-zinc-400">
                  Changes will be reviewed by an admin
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <button
            ...
            <Card className="bg-white dark:bg-zinc-800 border-gray-200 dark:border-zinc-700">
              <CardHeader>
                <CardTitle className="text-base text-gray-900 dark:text-white">How it works</CardTitle>
              </CardHeader>
              <CardContent className="text-sm text-gray-500 dark:text-zinc-400">
                <ul className="space-y-2">
                  <li>• Edit the fields you want to change</li>
                  <li>• Provide a reason for the changes</li>
                  <li>• An admin will review and approve or reject</li>
                </ul>
              </CardContent>
            </Card>
          </div>
