...
export function ExchangeRateCards() {
  ...
  if (isLoading) {
    return (
      <div className="rounded-xl bg-white dark:bg-[#0d0f13] border border-gray-200 dark:border-zinc-800/60 px-4 py-3 animate-pulse h-fit">
  ...
  if (error) {
    return (
      <div className="rounded-xl bg-white dark:bg-[#0d0f13] border border-gray-200 dark:border-zinc-800/60 px-4 py-3 h-fit">
  ...
  return (
    <div className="rounded-xl bg-white dark:bg-[#0d0f13] border border-gray-200 dark:border-zinc-800/60 px-4 py-3 h-fit card-hover-glow">
