...
export function ExchangeRateCards() {
  ...
  if (isLoading) {
    return (
      <div className="bg-white dark:bg-zinc-900/80 border border-zinc-200/60 dark:border-zinc-800/60 rounded-xl p-5 animate-pulse h-fit">
  ...
  if (error) {
    return (
      <div className="bg-white dark:bg-zinc-900/80 border border-zinc-200/60 dark:border-zinc-800/60 rounded-xl p-5 h-fit">
  ...
  return (
    <div className="bg-white dark:bg-zinc-900/80 border border-zinc-200/60 dark:border-zinc-800/60 rounded-xl p-5 h-fit hover:border-zinc-300 dark:hover:border-zinc-700 transition-colors">
