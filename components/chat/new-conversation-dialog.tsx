...
export function NewConversationDialog({ open, onClose, onCreated }: NewConversationDialogProps) {
  ...
  useEffect(() => {
    if (!open) {
      setName(""); setSubject(""); setSelectedMembers([]); setLinkType("none");
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center">
      ...
      <div className="relative w-full max-w-lg rounded-xl bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 shadow-xl mx-4">
        ...
        <div className="space-y-4 px-5 py-4">
          {/* Name */}
          <div>
            <label className="mb-1.5 block text-sm font-medium text-gray-700 dark:text-zinc-300">Name</label>
            <input
          ...
          {/* Subject */}
          <div>
            <label className="mb-1.5 block text-sm font-medium text-gray-700 dark:text-zinc-300">Subject <span className="text-gray-400 dark:text-zinc-500 font-normal">(optional)</span></label>
            <input
